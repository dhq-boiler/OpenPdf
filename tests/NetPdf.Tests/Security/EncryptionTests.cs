using NetPdf.Security;

namespace NetPdf.Tests.Security;
...
public class EncryptionTests
{
    ...
    public void CreateEncryption_ProducesValidDictionary()
    {
        ...
        var oStr = encDict.Get<NetPdf.Objects.PdfString>("O");
        var uStr = encDict.Get<NetPdf.Objects.PdfString>("U");
        Assert.NotNull(oStr);
        Assert.NotNull(uStr);
    ...
    public void CreateAndAuthenticate_UserPassword()
    {
        ...
        var idArray = new NetPdf.Objects.PdfArray();
        idArray.Add(new NetPdf.Objects.PdfString(fileId, isHex: true));
